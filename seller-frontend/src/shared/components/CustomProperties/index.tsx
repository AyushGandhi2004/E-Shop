                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div className="flex flex-col gap-3">
                                                ...
                                                properties.map((property, index)=>(
                                                    <div key={index} className="border border-gray-700 p-3 rounded-lg bg-gray-900">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <button type='button' className="" onClick={()=> removeProperty(index)}>
                                                        ...
                                                        <div className="flex flex-wrap gap-2 mt-2">
                                                            {
                                                                property.values.map((value,index)=>(
                                                                    <span key={index} className="px-2 py-1 bg-gray-700 text-white rounded-md">
                                                                        {value}
                                                                    </span>
                                                                ))
                                                            }
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                ...
                                                />
                                                <button type='button' className="px-3 py-2 bg-blue-500 text-white rounded-md flex" onClick={addProperty}>
                                                    <Plus size={16}/> Add
                                                </button>
                                            </div>
                                        </div>
